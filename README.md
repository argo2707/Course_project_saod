...
````
Листинг остального кода хеш-таблицы приведён в полном листинге кода программы в Source.cpp **ссылку!!!!!!!!!!!!!!!**
...
````
Листинг кода АВЛ-дерева приведён в полном листинге кода программы в **ссылку**.
...
Листинг кода слоеного списка приведён в полном листинге кода программы в **vgbgbghnhnhnhn**.
...
Все функции, указанные в главном меню, имеют такой же принцип взаимодействия. Подробнее о работе этих функции в следующем разделе «Тестирование программы».

Полный листинг кода программы приведён в приложении **555555555555**.
